...
import org.example.md3_sec1_jsp_servlet_crud.ra_crud.util.ConnectDB;
...
public class StudentDaoImpl implements IStudentDao {
    ...
    public List<Student> findAll() {
        ...
        Connection conn = ConnectDB.openConnection(); // Mở connection
        try {
            CallableStatement call = conn.prepareCall("select * from student"); // "select * from student" => Thay vì sử dụng procedure
